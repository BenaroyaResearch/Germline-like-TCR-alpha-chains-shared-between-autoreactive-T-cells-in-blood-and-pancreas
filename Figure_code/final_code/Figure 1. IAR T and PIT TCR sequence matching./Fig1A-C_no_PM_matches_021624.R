...
all = subset(tcrsCombSub3.u, set == "IAR1") # 5315 IAR1, 2286
all.u = all
...
#toChar = var1
toChar = subset(all.u, junction %in% intersect(mnTcrs.u$junction, all.u$junction))
...
##################
## make plot TRA/TRB overlap in IAR1
...
setwd("/Users/peterlinsley/Desktop/PIT_TCR_paper_code/Figure_PDFs")
filename = "Fig_1B_barplot_Perfectly matched PIT TCR junctions in IAR TCRs.pdf"
ggsave(filename, p)
...
setwd("/Users/peterlinsley/Desktop/PIT_TCR_paper_code/Figure_PDFs")
filename = "Fig_1C_barplot_Perfectly matched IAR TCR junctions in PIT CD4 CD8 cells.pdf"
ggsave(filename, p)
