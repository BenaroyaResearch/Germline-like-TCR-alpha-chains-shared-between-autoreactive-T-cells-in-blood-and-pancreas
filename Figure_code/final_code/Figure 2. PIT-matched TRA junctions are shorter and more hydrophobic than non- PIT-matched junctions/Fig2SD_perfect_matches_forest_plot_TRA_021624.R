...
all = subset(tcrsCombSub3.u, set == "IAR2" & chainType == "TRA") # 5315 IAR1, 2286
all.u = all
...
filename = "Fig_2D_Forest_plot_Numbers of PIT-matched versus non-matched junctions_TRA.pdf"
ggsave(filename, p)
