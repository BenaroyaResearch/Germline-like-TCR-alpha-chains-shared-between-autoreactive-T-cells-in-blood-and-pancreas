...
all = subset(tcrsCombSub3.u, set == "IAR1" & chainType == "TRA") # 
all.u = all
...
filename = "Fig_1F_IAR T cell and HC TRA junctions comparisons over a range_of_LI_values.pdf"
ggsave(filename, p)
...
p.adjust(c(0.0003776, 0.1204), method = "BH")
# 0.0007552 0.1204000
## method 2
summary(r.x)
