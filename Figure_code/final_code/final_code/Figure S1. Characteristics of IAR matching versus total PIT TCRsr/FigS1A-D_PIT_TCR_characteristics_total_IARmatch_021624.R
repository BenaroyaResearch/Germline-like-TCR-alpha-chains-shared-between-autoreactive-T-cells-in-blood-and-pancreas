...
var1 = mnTcrs.u$junction %in% intersect(mnTcrs$junction, all$junction)
toChar = subset(mnTcrs.u, junction %in% intersect(mnTcrs.u$junction, all.u$junction))
...
last_plot() + scale_fill_manual(values=cbPalette, labels = c("PIT-matched", "Total"))
xlab = "\nPIT TCR chain"
ylab = "Frequency\n"
...
## muktiple hypothesis testing

p.adjust(c(1.078e-11, 0.7028, 0.259, 0.7068), method = "BH")
# 4.312e-11 7.068e-01 5.180e-01 7.068e-01
