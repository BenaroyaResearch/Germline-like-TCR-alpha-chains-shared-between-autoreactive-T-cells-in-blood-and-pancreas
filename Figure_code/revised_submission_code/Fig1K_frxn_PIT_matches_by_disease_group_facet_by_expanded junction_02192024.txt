...
test1 = fisher.test(rbind(a,b)); test1$p.value # 0.08332905
test2 = fisher.test(rbind(a,c)); test2$p.value # 0.02476243
test3 = fisher.test(rbind(a,d)); test3$p.value # 0.6145677
test5 = fisher.test(rbind(b,c)); test5$p.value # 0.5917668
test6 = fisher.test(rbind(b,d)); test6$p.value # 0.1419553
test8 = fisher.test(rbind(c,d)); test8$p.value # 0.03118679
